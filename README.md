...
2. Ejecuta:
   ...
   Esto regenera `horarios.js` (datos que usa la app) y `horarios.json` (copia legible).
...
| `parser.js`    | Extrae materias/grupos/horarios del HTML            |
| `horarios.js`  | Datos parseados que carga la app                    |
